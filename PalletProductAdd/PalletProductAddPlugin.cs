...
namespace PalletProductAdd
{
    // TODO Review this file and update to your own requirements.

    [BepInPlugin(MyGUID, PluginName, VersionString)]
    public class PalletProductAddPlugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // 1.0.0
        private const string MyGUID = "com.Gamea.PalletProductAdd";
        private const string PluginName = "PalletProductAdd";
        ...
        // e.g.
        // float myFloat = PalletProductAddPlugin.FloatExample.Value;
        ...
        private void Awake()
        {
            ...
            // .e.g.
            // PalletProductAddPlugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (PalletProductAddPlugin.KeyboardShortcutExample.Value.IsDown())
            {
