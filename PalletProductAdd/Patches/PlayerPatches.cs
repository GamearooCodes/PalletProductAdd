...
namespace PalletProductAdd.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            PalletProductAddPlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            PalletProductAddPlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}